...
$entries = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}mtrlwid ORDER BY id DESC LIMIT $offset, $limit" );
...
$total = $wpdb->get_var( "SELECT COUNT(`id`) FROM {$wpdb->prefix}mtrlwid" );
$num_of_pages = ceil( $total / $limit );
$page_links = paginate_links( array(
    'base' => add_query_arg( 'pagenum', '%#%' ),
    'format' => '',
    'prev_text' => __( '&laquo;', 'mtrl_framework' ),
    'next_text' => __( '&raquo;', 'mtrl_framework' ),
    'total' => $num_of_pages,
    'current' => $pagenum
) );
